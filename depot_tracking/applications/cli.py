...
from depot_tracking.applications.download.download_service.downloader_factory import SUPPORTED_DOWNLOADER_BANKS
...
from depot_tracking.components.ingestion.parsing import SUPPORTED_BANKS as SUPPORTED_PARSER_BANKS
