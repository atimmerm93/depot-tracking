...
from banking_app.applications.di import resolve_application
from banking_app.applications.download.cli_output import DownloadingCliOutput
...
from banking_app.applications.download.gateway import SeleniumDownloaderGateway
